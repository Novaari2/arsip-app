                    ...
                    <form class="forms-sample" action="{{ route('risalah_lelang.create') }}" method="POST">
                        ...
                        <div class="form-section">
                            <div class="form-group">
                                ...
                                <input type="text" id="no_risalah_lelang" name="no_risalah_lelang" class="form-control" value="{{ $risalah->no_risalah }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="tgl_lelang" name="tgl_lelang" class="form-control" value="{{ date('Y-m-d', strtotime($risalah->tgl_lelang)) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="no_regis" name="no_regis" class="form-control" value="{{ $risalah->no_register }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="tgl_regis" name="tgl_regis" class="form-control" value="{{ date('Y-m-d', strtotime($risalah->tgl_register)) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="no_tiket_pemohon" name="no_tiket_pemohon" class="form-control" value="{{ $risalah->no_tiket_permohonan }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_entitas" name="nama_entitas" class="form-control" value="{{ $risalah->nama_entitas_pemohon }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="tgl_surat_pemohon" name="tgl_surat_pemohon" class="form-control" value="{{ date('Y-m-d', strtotime($risalah->tgl_permohonan)) }}">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_pemohon" name="nama_pemohon" class="form-control" value="{{ $risalah->nama_pemohon }}">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select name="kategori_pemohon" id="kategori_pemohon" class="form-control">
                                        <option value="{{ $risalah->kategoriPemohon->id }}">{{ $risalah->kategoriPemohon->nama }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="no_surat_pemohon" name="no_surat_pemohon" class="form-control" value="{{ $risalah->no_permohonan }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_debitur" name="nama_debitur" class="form-control" value="{{ $risalah->nama_debitur }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="no_hpkb" name="no_hpkb" class="form-control" value="{{ $risalah->no_hpkb }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="tgl_hpkb" name="tgl_hpkb" class="form-control" value="{{ date('Y-m-d', strtotime($risalah->tgl_hpkb)) }}">
                        ...
                        <div class="form-section">
                            <div class="form-group">
                                ...
                                <input type="text" id="no_penetapan_jadwal" name="no_penetapan_jadwal" class="form-control" value="{{ $risalah->no_penetapan }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="tgl_penetapan_jadwal" name="tgl_penetapan_jadwal" class="form-control" value="{{ date('Y-m-d', strtotime($risalah->tgl_penetapan)) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="tempat_lelang" name="tempat_lelang" class="form-control" value="{{ $risalah->tempat_lelang }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="st_lelang" name="st_lelang" class="form-control" value="{{ $risalah->st_lelang }}">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select name="nama_pejabat_lelang" id="nama_pejabat_lelang" class="form-control">
                                        <option value="{{ $risalah->pejabatLelang->id }}">{{ $risalah->pejabatLelang->nama }}</option>
                                        @foreach($pejabat_lelang as $pejabat)
                                            <option value="{{ $risalah->pejabatLelang->id }}" {{ old('nama_pejabat_lelang') == $pejabat->nama ? 'selected' : '' }}>{{ $pejabat->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="tgl_surat_tugas" name="tgl_surat_tugas" class="form-control" value="{{ date('Y-m-d', strtotime($risalah->tgl_surat_tugas)) }}">
                        ...
                        <div class="form-section">
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_penjual" name="nama_penjual" class="form-control" value="{{ $risalah->nama_penjual }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="no_surat_tugas_penjual" name="no_surat_tugas_penjual" class="form-control" value="{{ $risalah->no_surat_tugas_penjual }}">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select name="jenis_lelang" class="form-control" id="jenis_lelang">
                                        <option value="{{ $risalah->jenisLelang->id }}">{{ $risalah->jenisLelang->nama }}</option>
