...
@include('layouts.overview', ['text' => 'Rak Gudang', 'icon' => 'mdi mdi-airplay'])
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <a href="{{ route('rak_gudang.create') }}" class="btn btn-sm bg-green text-white aadd mb-4"><i class="mdi mdi-airplus"></i>Tambah</a>
...
<script>
    ...
    $(document).on('click','.delete-rak_gudang', function() {
            let id = $(this).data('id');
