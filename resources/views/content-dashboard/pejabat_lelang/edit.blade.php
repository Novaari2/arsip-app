...
@include('layouts.overview',['text' => 'Edit Pejabat Lelang','icon' => 'mdi mdi-airplay'])
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form class="forms-sample" action="{{ route('pejabat_lelang.update', Request::segment(4, 'default')) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="sk" name="sk" class="form-control" value="{{ $data->sk_pengangkatan }}">
                            @if($errors->has('sk'))
