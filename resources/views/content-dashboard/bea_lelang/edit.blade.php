...
@include('layouts.overview',['text' => 'Edit Bea Lelang','icon' => 'mdi mdi-airplay'])
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form class="forms-sample" action="{{ route('bea_lelang.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
