...
@include('layouts.overview', ['text' => 'Bea Lelang', 'icon' => 'mdi mdi-airplay'])
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <a href="{{ route('bea_lelang.add') }}" class="btn btn-sm bg-green text-white aadd mb-4"><i class="mdi mdi-airplus"></i>Tambah</a>
...
<script>
    ...
    $(document).on('click','.bea-lelang', function() {
            let id = $(this).data('id');
